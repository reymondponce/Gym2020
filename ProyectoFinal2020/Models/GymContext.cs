...
namespace ProyectoFinal2020.Models
{
    public partial class GymContext : DbContext
    {
        ...
        public virtual DbSet<ClienteHijo> ClienteHijo { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=DESKTOP-GC3346J\\SQLEXPRESS;Database=Gym;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ClaseGuarderia>(entity =>
            {
                ...
                entity.Property(e => e.IdClaseGuarderia)
                    .HasMaxLength(25)
                    .IsUnicode(false);
            ...
            modelBuilder.Entity<ClaseGuarderiaEmpleado>(entity =>
            {
                ...
                entity.Property(e => e.IdClaseGuarderiaEmpleado)
                    .HasColumnName("IdClaseGuarderia_Empleado")
                    .HasMaxLength(50)
                    .IsUnicode(false);
            ...
            modelBuilder.Entity<ClaseGym>(entity =>
            {
                ...
                entity.Property(e => e.IdClaseGym)
                    .HasMaxLength(25)
                    .IsUnicode(false);
                ...
                entity.HasOne(d => d.IdActividadNavigation)
                    ...
                    .HasConstraintName("FK_ClaseGym_Actividad");
            });
            ...
            modelBuilder.Entity<ClienteHijo>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("Cliente_Hijo");
            });
            ...
            modelBuilder.Entity<HijoCliente>(entity =>
            {
                ...
                entity.Property(e => e.IdHijoCliente)
                    .HasColumnName("IdHijo_Cliente")
                    .HasMaxLength(10)
                    .IsFixedLength();
            ...
            modelBuilder.Entity<MatriculaClaseGym>(entity =>
            {
                ...
                entity.HasOne(d => d.IdClaseGymNavigation)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_MatriculaClaseGym_ClaseGym");
            });
            ...
            modelBuilder.Entity<MatriculaGuarderia>(entity =>
            {
                ...
                entity.HasOne(d => d.IdClaseGuarderiaNavigation)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_MatriculaGuarderia_ClaseGuarderia");
            });
            ...
            modelBuilder.Entity<MovimientoMonedero>(entity =>
            {
                ...
                entity.Property(e => e.IdMonedero).ValueGeneratedNever();

                entity.HasOne(d => d.IdTipoMovimientoNavigation)
                    .WithMany(p => p.MovimientoMonedero)
